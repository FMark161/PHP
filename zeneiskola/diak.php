...
$sql = "SELECT * FROM diak ORDER BY id";
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <?php if (!empty($row['szuletesi_datum'])): ?>
                            <?php echo h($row['telefonszam']); ?>
                        <td><?php echo h($row['iskolaid']); ?></td>
                        <td><?php echo h($row['kolcsonzott_hangszerek']); ?></td>
                        </a>
                    <?php endif; ?>
